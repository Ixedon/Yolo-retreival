...
def main(confidence = None, threshold = None):
	if confidence != None:
	...
	results.append((confidence, threshold, int (10000 * all_acc/count)/100,  int (10000* tot_time)/10000, int (10000* tot_time/count )/10000))
...
if __name__ == "__main__":
	...
	for i in frange(0.0,0.3, 0.3/30):
		for j in frange(0.5,0.7, 0.3/30):
			print ('\n\n',i, j)
			main(i,j)
	print ("\nResults\n")
	print ("Confidence", "Threshold", "Accuracy", "Total_time", "Average_time_per_frame")
	for res in results:
		print (str(' ').join (str(res)[2:-2].split(',')))
